...
CREATE TABLE IF NOT EXISTS "equipment" (
    ...
    -- 0 = optional, >0 = mandatory minimum
    PRIMARY KEY("id" AUTOINCREMENT),
    FOREIGN KEY("facility_type_id") REFERENCES "facility_types"("id")
);
...
-- ---------- FACILITIES ----------
-- Tennis: 3 courts
INSERT INTO "facilities" ("code", "facility_type_id")
VALUES ('T1', 1),
    ('T2', 1),
    ('T3', 1);
-- Basketball: 2 courts
...
VALUES (1, 1, 'tennis_racket', 8, 8, 2),
...
VALUES (11, 5, 'table_tennis_racket', 8, 8, 2),
...
VALUES (
        ...
        '704e1fe979a047436eb7d1766e782e72a76df6da80da3e1f202c37e42208cf8e',
        '8f650e1213b07092045b20d53fcab067',
        NULL,
        NULL
    ),
    (
        ...
        'Rossi',
        'user2@example.com',
        '929ac971b0938185a8b15995801ba023b90968f8c98813b0da16b2d6f7009b62',
        '7d6342853652c5951b8bb683a404922e',
    ...
    (
        ...
        'Verdi',
        'user3@example.com',
        '28f2ff0d3be5d62176bb9543be0494f4f5764b3958d96a5877b0cf2ed7b43785',
        '9f05bb88125fdf55b89aabc279d63e84',
        NULL,
        NULL
    ),
    (
        ...
        'Neri',
        'user4@example.com',
        'af885fc18e91ec720aae870927f6d8d8f423748ec3150f5a165a3efb9ddbee4c',
        '5e931bb30b7e1a50ffdbf0002fe3c3be',
        'LXBSMDTMSP2I5XFXIYRGFVWSFI',
        NULL
    );
-- ============================================================
...
VALUES (1, 2, 'T1', datetime('now', '-1 day'), 'active');
INSERT INTO "rents" ("reservation_id", "equipment_id", "quantity")
VALUES (1, 1, 2),
    -- 2 tennis racket (min)
    (1, 2, 3);
-- 3 tennis ball (min)
...
VALUES (2, 3, 'B1', datetime('now', '-1 day'), 'active');
INSERT INTO "rents" ("reservation_id", "equipment_id", "quantity")
VALUES (2, 4, 1);
-- 1 basketball (min)
UPDATE "facilities"
...
VALUES (3, 4, 'V1', datetime('now', '-1 day'), 'active');
INSERT INTO "rents" ("reservation_id", "equipment_id", "quantity")
VALUES (3, 6, 1);
-- 1 volleyball (min)
UPDATE "facilities"
...
VALUES (4, 4, 'P1', datetime('now', '-1 day'), 'active');
INSERT INTO "rents" ("reservation_id", "equipment_id", "quantity")
VALUES (4, 11, 2),
    -- 2 table_tennis_racket (min)
    (4, 12, 1);
-- 1 table_tennis_ball (min)
UPDATE "facilities"
SET "is_booked" = 1
WHERE "code" = 'P1';
UPDATE "equipment"
